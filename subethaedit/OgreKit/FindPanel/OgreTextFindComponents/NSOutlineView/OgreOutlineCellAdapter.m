...
- (void)setString:(NSString*)aString
{
    ...
    if ([outlineColumn isEditable]) {
        ...
        [dataCell setStringValue:aString];
...
- (void)replaceCharactersInRange:(NSRange)aRange withString:(NSString*)aString
{
    ...
    if ([outlineColumn isEditable]) {
        ...
        NSMutableString *newString = [NSMutableString stringWithString:[self string]];
        [newString replaceCharactersInRange:aRange withString:aString];
