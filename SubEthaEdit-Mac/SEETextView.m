...
- (void)setBackgroundColor:(NSColor *)aColor {
	...
	[(LayoutManager *)self.layoutManager setInactiveSelectionColor:[aColor blendedColorWithFraction:0.3 ofColor:[NSColor colorWithCalibratedWhite:isDark ? 1.0 : 0.0 alpha:1.0]]];
