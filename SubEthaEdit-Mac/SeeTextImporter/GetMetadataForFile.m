			   ...
			   CFStringRef pathToFile)
{
    ...
    NSError *err=nil;
    NSXMLDocument *metadata = [[[NSXMLDocument alloc] initWithData:[NSData dataWithContentsOfFile:[(NSString *)pathToFile stringByAppendingPathComponent:@"metadata.xml"]] options:0 error:&err] autorelease];
    if (!err) {
