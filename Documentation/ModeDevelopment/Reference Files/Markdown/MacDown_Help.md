...
Perhaps you want to some link text like this: [Macdown Website](https://macdown.uranusjr.com "Title")  
...
Autolink            | https://t.co      | <https://t.co>         |
...
My editor provides syntax highlighting. You can edit the base font and the coloring/sizing theme. I provided some default themes (courtesy of [Mou](https://mouapp.com)’s creator, Chen Luo) if you don’t know where to start.
